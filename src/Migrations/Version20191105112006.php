 ...
 */
final class Version20191105112006 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE moto RENAME COLUMN placa_max TO places_max');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE moto RENAME COLUMN places_max TO placa_max');
    }
}
